...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    itemPaddingTop: PropTypes.number,
    itemPaddingBottom: PropTypes.number,
              ...
              {!single && !hideSubmitButton && (
                  <TouchableOpacity
                      ...
                      style={[
                        ...
                        this.props.submitButtonStyle || {}, // Add custom styles here
                      ]}
                  >
                    <Text
                        style={[
                          styles.buttonText,
                          fontFamily ? { fontFamily } : {},
                          this.props.submitTextStyle || {}, // Add custom styles here
                        ]}
                    >
                      {submitButtonText}
                    </Text>
